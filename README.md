...
provider boundary ready for production STT/TTS adapters.

Run `npm run dev`, open `http://127.0.0.1:3000`, and allow microphone access.
Chrome or Edge currently provides the broadest Web Speech API support. Run
`npm run check` to verify frontend lint/build and backend Ruff/Pytest.
